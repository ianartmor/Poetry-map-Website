...
your_map <- leaflet(locs_sf) %>%  
  ...
  addMarkers(data= locs_sf,
    ...
    addPolygons(data= neighborhoods, fillOpacity =0, opacity = 0.4,weight=1, group  = "View Neighborhood Boundaries"
                ) %>%
  addControlGPS(
...
To print a list of poetry posts in your neighborhood, select your neighborhood and click the "print" button.
```{r, echo =FALSE}
